...
/**
 * @brief Per-event always-contains between two single-instant tcbuffer built from event fields.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AcontainsTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcontainsTcbufferTcbuffer";

    AcontainsTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
