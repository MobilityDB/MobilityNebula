...
/**
 * @brief Per-event ever-contains between two single-instant tcbuffer built from event fields.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `econtains_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EcontainsTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcontainsTcbufferTcbuffer";

    EcontainsTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
