...
/**
 * @brief Per-event ever-covers between a single-instant tgeo built from event fields and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ecovers_tgeo_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EcoversTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcoversTgeoGeo";

    EcoversTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
