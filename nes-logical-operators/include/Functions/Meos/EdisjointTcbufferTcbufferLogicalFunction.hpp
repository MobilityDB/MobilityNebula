...
/**
 * @brief Per-event ever-disjoint between two single-instant tcbuffer built from event fields.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edisjoint_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EdisjointTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdisjointTcbufferTcbuffer";

    EdisjointTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
