...
/**
 * @brief Per-event ever-disjoint between a single-instant tgeo built from event fields and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edisjoint_tgeo_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EdisjointTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdisjointTgeoGeo";

    EdisjointTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
