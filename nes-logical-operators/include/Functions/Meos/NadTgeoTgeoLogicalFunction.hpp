...
/**
 * @brief Per-event nearest-approach distance between two single-instant tgeo built from event fields.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTgeoTgeo";

    NadTgeoTgeoLogicalFunction(LogicalFunction lonA,
