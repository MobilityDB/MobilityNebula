...
/**
 * @brief tbox_make (TBox *) — TBox from a value span + time span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxMake";

    TboxMakeLogicalFunction(LogicalFunction lit,
