...
/**
 * @brief Physical operator for `edisjoint_tcbuffer_tcbuffer`.
 *
 * Per-event ever-disjoint between two single-instant tcbuffer built from event fields.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class EdisjointTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
