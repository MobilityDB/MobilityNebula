...
/**
 * @brief Physical operator for `nad_tgeo_tgeo`.
 *
 * Per-event nearest-approach distance between two single-instant tgeo built from event fields.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class NadTgeoTgeoPhysicalFunction : public PhysicalFunctionConcept {
public:
